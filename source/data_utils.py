...
class Corpus(object):
    def __init__(self, path, dataset, *args, **kwargs):
        ...
        if self.dataset in ['ptb', 'wt2', 'enwik8', 'text8']:
            ...
            self.vocab.count_banking77(os.path.join(path, 'train.tsv'), add_cls_token=True)
            self.vocab.count_banking77(os.path.join(path, 'dev.tsv'), add_cls_token=True)
    ...
    def get_iterator(self, split, *args, **kwargs):
        ...
        if split == 'train':
            ...
            elif self.dataset in ['sst2', 'imdb', 'sst5', 'banking77']:
...
def get_lm_corpus(datadir, dataset):
    ...
    if os.path.exists(fn):
        ...
        elif dataset in ['csqa', 'sst2', 'imdb', 'sst5', 'banking77']:
            kwargs['special'] = ['<eos>']
