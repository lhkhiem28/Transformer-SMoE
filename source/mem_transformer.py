...
class RelMultiHeadAttn_MoE(nn.Module):
    def __init__(self, n_head, d_model, d_head, dropout, dropatt=0,
                 tgt_len=None, ext_len=None, mem_len=None, pre_lnorm=False,
                 moe=False, moe_num_expert=64, moe_top_k=2, gate_name=None, **kwargs):
        super(RelMultiHeadAttn_MoE, self).__init__()
        ...
        self.qkv_net = moe_qkv(16, d_model=d_model, d_hidden=3 * n_head * d_head, top_k=1, activation=None, gate=CustomNaiveGate_Attn)
...
class RelPartialLearnableMultiHeadAttn_MoE(RelMultiHeadAttn_MoE):
    def __init__(self, *args, **kwargs):
        super(RelPartialLearnableMultiHeadAttn_MoE, self).__init__(*args, **kwargs)
...
class RelPartialLearnableDecoderLayer(nn.Module):
    def __init__(self, n_head, d_model, d_head, d_inner, dropout,
        ...
        if kwargs.get('moe_attn') is False:
            self.dec_attn = RelPartialLearnableMultiHeadAttn(n_head, d_model,
                                d_head, dropout, **kwargs)
        else:
            self.dec_attn = RelPartialLearnableMultiHeadAttn_MoE(n_head, d_model,
                                d_head, dropout, **kwargs)
